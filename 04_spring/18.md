...
<div align="left"><img src="https://i.imgur.com/RlHVydi.png" title="source: imgur.com" width="25px"/> <a href="https://www.base64url.com" target="_blank"><b>Ferramenta: Codificador Base 64</b></a></div>
...
<div align="center"><img src="https://imgur.com/DxllAo6.png" title="source: imgur.com" /></div>
...
**Linha 66:** O Filtro Retornará o **HTTP Status 401 🡪 UNAUTHORIZED**. Este Status indica que o Token é inválido e por isso o acesso não foi permitido. Neste caso, o usuário deve se autenticar novamente no sistema e gerar um novo Token.

**Linha 67:** Observe que a palavra **return** foi inserida sozinha, sem nenhum valor, indicando que após retornar  o **HTTP Status 401 🡪 UNAUTHORIZED**, a execução do Filtro de Servlet **JwtAuthFilter** deve ser finalizada imediatamente.
