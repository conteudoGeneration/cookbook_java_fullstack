...
3. Antes de começar a testar todas Requisições do Deploy no Render, Faça o login utilizando usuário **root@root.com**, através da Requisição **Login**, da pasta **Render**.

4. **Não se esqueça de atualizar o Token de todas as Requisições protegidas**. 
