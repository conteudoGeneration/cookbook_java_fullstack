...
O Ecossistema do Usuario é a parte responsável por definir os dados do nosso Objeto Usuario, que será utilizado para autenticar e autorizar o acesso ao Blog Pessoal, quando a camada de segurança da aplicação estiver completamente implementada.
