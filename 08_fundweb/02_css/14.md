...
O **CSS Grid Layout** é uma especificação poderosa que, quando combinada com outros recursos do CSS, como o *Flexbox*, permite a criação de layouts complexos com **mais clareza, controle e simplicidade** em comparação aos métodos tradicionais.

Trata-se de um **sistema de layout bidimensional**, projetado para organizar elementos simultaneamente em **linhas e colunas**. Com o Grid, é possível definir estruturas mais precisas, controlar espaçamentos, alinhamentos e proporções de forma nativa — algo que antes exigia múltiplas técnicas e soluções alternativas em CSS.
...
O espaçamento entre as linhas do Grid é chamado de **Row Gap** e o espaçamento entre as colunas do Grid é chamado de **Column Gap**.

<br />

> [!IMPORTANT]
>
> Tradicionalmente, esses espaçamentos eram definidos por `row-gap` e `column-gap`, mas atualmente recomenda-se o uso da propriedade abreviada `gap`, que veremos neste conteúdo.
...
Entre os principais benefícios do **CSS Grid Layout**, destacam-se:

- **Flexibilidade e responsividade**, adaptando-se facilmente a diferentes tamanhos de tela;
- **Facilidade na criação de layouts bidimensionais**, organizando elementos em linhas e colunas;
- **Amplo suporte pelos navegadores modernos**, aliado a uma sintaxe simples de utilizar;
- **Marcação HTML mais limpa**, com maior controle e flexibilidade na organização do layout.
...
<div align="left"><img src="https://i.imgur.com/63FhSvn.png" title="source: imgur.com" width="4%"/> <a href="https://www.w3schools.com/cssref/pr_grid-template-columns.php" target="_blank"><b>Documentação: Grid Template Columns</b></a></div>
...
<div align="left"><img src="https://i.imgur.com/63FhSvn.png" title="source: imgur.com" width="4%"/> <a href="https://www.w3schools.com/cssref/pr_grid-template-rows.php" target="_blank"><b>Documentação: Grid Template Rows</b></a></div>
...
Experimente trocar os valores da propriedade `grid-template`, assim como fizemos com as propriedades `grid-template-columns` e `grid-template-rows`.

<br />

<div align="left"><img src="https://i.imgur.com/63FhSvn.png" title="source: imgur.com" width="4%"/> <a href="https://www.w3schools.com/cssref/pr_grid-template.php" target="_blank"><b>Documentação: Grid Template</b></a></div>
...
<div align="left"><img src="https://i.imgur.com/63FhSvn.png" title="source: imgur.com" width="4%"/> <a href="https://www.w3schools.com/cssref/css3_pr_gap.php" target="_blank"><b>Documentação: Grid Gap</b></a></div>
...
As propriedades `grid-template-rows` e `grid-template-columns` possuem uma função muito interessante, quando se deseja criar um layout onde as linhas e colunas manterão um mesmo padrão de altura e largura por todo o layout. Trata-se da função **repeat()**, que funciona como um Laço de Repetição, posicionando todos os itens no grid, seguindo um mesmo padrão. 
...
- **Número de Linhas ou Colunas:** Define o número de linhas ou colunas do Grid. No exemplo acima, como estamos utilizando a propriedade `grid-template-columns`, definimos que serão 2 colunas por linha.
...
<div align="left"><img src="https://i.imgur.com/63FhSvn.png" title="source: imgur.com" width="4%"/> <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/repeat" target="_blank"><b>Documentação: Função repeat()</b></a></div>

<div align="left"><img src="https://i.imgur.com/63FhSvn.png" title="source: imgur.com" width="4%"/> <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/minmax" target="_blank"><b>Documentação: Função minmax()</b></a></div>
...
>
> Não existe uma receita universal para estilizar uma página com CSS. Utilize a sua criatividade, os conhecimentos adquiridos, leia a documentação e crie seus próprios layouts ou experimente clonar um layout existente.

<br />

<div align="left"><img src="https://i.imgur.com/63FhSvn.png" title="source: imgur.com" width="4%"/> <a href="https://css-tricks.com/snippets/css/complete-guide-grid/" target="_blank"><b>Tutorial: Guia Completo do CSS Grid - CSS Tricks</b></a></div>

<div align="left"><img src="https://i.imgur.com/63FhSvn.png" title="source: imgur.com" width="4%"/> <a href="https://developer.mozilla.org/pt-BR/docs/Web/CSS/CSS_grid_layout" target="_blank"><b>CSS Grid - MDN</b></a></div>
