...
1. Como vimos anteriormente, o **JavaScript** é uma linguagem de programação que foi originalmente criada para tornar as páginas web interativas. Quando executado em navegadores, o JavaScript funciona com base em três componentes principais:
...
```js
// Exibir o conteúdo HTML interno do elemento titulo
const conteudo_titulo = elemento_titulo.innerHTML;
console.log(conteudo_titulo);

// Alterar o conteúdo HTML interno do elemento titulo
elemento_titulo.innerHTML = "<h1>Novo Título</h1>";

// Alterar a cor do texto do elemento titulo via CSS inline
...
```js
// Após 10 segundos, remover o novo elemento do DOM
setTimeout(() => {
