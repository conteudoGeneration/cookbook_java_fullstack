...
4. Caso estas linhas não sejam encontradas no arquivo **tsconfig.json**, verifique se o seu projeto possui o arquivo **tsconfig.app.json** e verifique se estas linhas foram adicionadas neste arquivo.
5. Caso tenham sido adicionadas, deixe elas comentadas:
